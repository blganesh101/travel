...
public class Search_Audio extends Activity implements OnItemClickListener {
	...
	protected void onResume() {
		...
		search.setAdapter(new ArrayAdapter<String>(getBaseContext(),
				android.R.layout.simple_list_item_1, MediaAudioList.arr_title));
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		//System.out.println("URIIIIIIIIIIIIIIIIIII "+MediaAudioList.arr_path_uri.get(arg2));
		b.putString("uri", MediaAudioList.arr_path_uri.get(arg2));
		i.putExtras(b);
		startActivity(i);
	}
